    ...
    public static class CButton {
        ...
        public static class dest {
            ...
            public static CTxT clear(Player player) {
                ...
                return CTxT.of(symbols.x()).btn(true).color(o?'c':'7').cEvent(o?1:0,"/dest clear").hEvent(
            ...
            public static CTxT trackX() {
                return CTxT.of(symbols.x()).btn(true).color('c').cEvent(1,"/dest track .clear").hEvent(
                        CTxT.of(cmdUsage.destTrackClear()).color('c').append("\n").append(TBtn("dest.track_clear.hover")));
            }
        }
        public static class hud {
            public static CTxT color() {
                return TBtn("hud.color").rainbow(true,15f,45f).btn(true).cEvent(1,"/hud color")
                        .hEvent(CTxT.of(cmdUsage.hudColor()).rainbow(true,10f,23f).append("\n").append(TBtn("hud.color.hover")));
            }
