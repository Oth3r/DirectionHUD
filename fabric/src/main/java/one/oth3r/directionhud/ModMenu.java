...
public class ModMenu implements ModMenuApi {
    private static MutableText tLang(String key, Object... args) {
        return CUtl.lang(key, args).b();
    }
    @Override
    public ConfigScreenFactory<?> getModConfigScreenFactory() {
        return parent -> YetAnotherConfigLib.createBuilder().save(config::save)
                ...
                .category(ConfigCategory.createBuilder()
                        .name(tLang("config"))
                        .tooltip(tLang("config_info"))
                        .option(Option.<Integer>createBuilder()
                                .name(tLang("config.max_xz"))
                                .description(OptionDescription.of(tLang("config.max_xz.info")))
                                .binding(config.defaults.MAXxz, () -> config.MAXxz, n -> config.MAXxz = n)
                                .controller(IntegerFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(tLang("config.max_y"))
                                .description(OptionDescription.of(tLang("config.max_y.info")))
                                .binding(config.defaults.MAXy, () -> config.MAXy, n -> config.MAXy = n)
                                .controller(IntegerFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.dest_saving"))
                                .description(OptionDescription.of(tLang("config.dest_saving.info")))
                                .binding(config.defaults.DESTSaving, () -> config.DESTSaving, n -> config.DESTSaving = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.social"))
                                .description(OptionDescription.of(tLang("config.social.info")))
                                .binding(config.defaults.social, () -> config.social, n -> config.social = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(tLang("config.max_saved"))
                                .description(OptionDescription.of(tLang("config.max_saved.info")))
                                .binding(config.defaults.MAXSaved, () -> config.MAXSaved, n -> config.MAXSaved = n)
                                .controller(IntegerFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.death_saving"))
                                .description(OptionDescription.of(tLang("config.death_saving.info")))
                                .binding(config.defaults.deathsaving, () -> config.deathsaving, n -> config.deathsaving = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.hud_editing"))
                                .description(OptionDescription.of(tLang("config.hud_editing.info")))
                                .binding(config.defaults.HUDEditing, () -> config.HUDEditing, n -> config.HUDEditing = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(tLang("config.hud_refresh"))
                                .description(OptionDescription.of(tLang("config.hud_refresh.info")))
                                ...
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.online_mode"))
                                .description(OptionDescription.of(tLang("config.online_mode.info")))
                                .binding(config.defaults.online, () -> config.online, n -> config.online = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .group(ListOption.<String>createBuilder()
                                .name(tLang("config.dimensions"))
                                ...
                                .build())
                        .group(ListOption.<String>createBuilder()
                                .name(tLang("config.dimension_ratios"))
                                .description(OptionDescription.of(tLang("config.dimension_ratios.info")))
                        ...
                        .build())
                .category(ConfigCategory.createBuilder()
                        .name(tLang("config.hud"))
                        .tooltip(tLang("config.hud_info"))
                        .option(Option.<Boolean>createBuilder()
                                .name(tLang("config.hud.enabled"))
                                .description(OptionDescription.of(tLang("config.hud.enabled.description")))
                                .binding(config.defaults.HUDEnabled, () -> config.HUDEnabled, n -> config.HUDEnabled = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .group(ListOption.<String>createBuilder()
                                .name(tLang("config.hud.order"))
                                .description(OptionDescription.of(tLang("config.hud.order.description")))
                        ...
                        .build())
                .category(ConfigCategory.createBuilder()
                        .name(tLang("config.dest"))
                        .tooltip(tLang("config.dest_info"))
                        .group(OptionGroup.createBuilder()
                                .name(tLang("dest.setting.destination"))
                                .description(OptionDescription.of(tLang("config.dest.description")))
                                .option(Option.<Boolean>createBuilder()
                                        .name(tLang("dest.setting.autoclear"))
                                        .binding(config.defaults.DESTAutoClear, () -> config.DESTAutoClear, n -> config.DESTAutoClear = n)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(tLang("config.dest.autoclear_rad"))
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .build())
                        .group(OptionGroup.createBuilder()
                                .name(tLang("dest.setting.features"))
                                .description(OptionDescription.of(tLang("config.dest.feature.description")))
                                .option(Option.<Boolean>createBuilder()
                                        .name(tLang("dest.setting.send"))
                                        .binding(config.defaults.DESTSend, () -> config.DESTSend, n -> config.DESTSend = n)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(tLang("dest.setting.track"))
                                        .binding(config.defaults.DESTTrack, () -> config.DESTTrack, n -> config.DESTTrack = n)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(tLang("dest.setting.lastdeath"))
