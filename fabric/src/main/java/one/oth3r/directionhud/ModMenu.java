...
public class ModMenu implements ModMenuApi {
    ...
    public Text txt(String s) {
        return Text.of(s);
    }
    public OptionDescription desc(CTxT txt) {
        return OptionDescription.of(txt.b());
    }
    public ConfigCategory mainCategory() {
        return ConfigCategory.createBuilder()
                .name(config.LANG.ui("main").b())
                // MAX LOC group
                .group(OptionGroup.createBuilder()
                        .name(config.LANG.ui("max").b())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("max-xz"))
                                .description(desc(config.LANG.desc("max.xyz")))
                ...
                .option(Option.<Boolean>createBuilder()
                        .name(txt("online-mode"))
                        .description(desc(config.LANG.desc("online_mode")))
                        .binding(config.defaults.online, () -> config.online, n -> config.online = n)
                        .controller(TickBoxControllerBuilder::create)
                        .build())
                .option(Option.<Boolean>createBuilder()
                        .name(txt("hud-editing"))
                        .description(desc(config.LANG.desc("hud_editing")))
                        .binding(config.defaults.HUDEditing, () -> config.HUDEditing, n -> config.HUDEditing = n)
                        .controller(TickBoxControllerBuilder::create)
                        .build())
                // DEST group
                .group(OptionGroup.createBuilder()
                        .name(Destination.LANG.ui().b())
                        .option(Option.<Boolean>createBuilder()
                                .name(txt("global-destinations"))
                                .description(desc(config.LANG.desc("global_dest").append("\n")
                                        .append(config.LANG.desc("global_dest.2").color('7'))))
                                .binding(config.defaults.globalDESTs, () -> config.globalDESTs, n -> config.globalDESTs = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(txt("destination-saving"))
                                .description(desc(config.LANG.desc("dest_saving")))
                                .binding(config.defaults.DestSaving, () -> config.DestSaving, n -> config.DestSaving = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("destination-max"))
                                .binding(config.defaults.DestMAX, () -> config.DestMAX, n -> config.DestMAX = n)
                                .controller(IntegerFieldControllerBuilder::create)
                                .build())
                        .option(Option.<Boolean>createBuilder()
                                .name(txt("lastdeath-saving"))
                                .description(desc(config.LANG.desc("lastdeath_saving")))
                                .binding(config.defaults.LastDeathSaving, () -> config.LastDeathSaving, n -> config.LastDeathSaving = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("lastdeath-max"))
                ...
                // SOCIAL group
                .group(OptionGroup.createBuilder()
                        .name(config.LANG.ui("social").b())
                        .option(Option.<Boolean>createBuilder()
                                .name(txt("social-commands"))
                                .description(desc(config.LANG.desc("social_commands")))
                                .binding(config.defaults.social, () -> config.social, n -> config.social = n)
                                .controller(TickBoxControllerBuilder::create)
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("social-cooldown"))
                                .description(desc(config.LANG.desc("social_cooldown")))
                ...
                // LOOP group
                .group(OptionGroup.createBuilder()
                        .name(config.LANG.ui("loop").b())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("hud-loop"))
                                .description(desc(config.LANG.desc("hud_loop")))
                                ...
                                .build())
                        .option(Option.<Integer>createBuilder()
                                .name(txt("particle-loop"))
                                .description(desc(config.LANG.desc("particle_loop")))
