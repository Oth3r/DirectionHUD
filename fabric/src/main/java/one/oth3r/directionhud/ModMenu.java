        ...
        return parent -> YetAnotherConfigLib.createBuilder().save(config::save)
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.of("ActionBars in chat (temp)"))
                                .description(OptionDescription.of(Text.of("Toggle sending non DirectionHUD ActionBars in chat.")))
                                .binding(config.defaults.actionBarChat, () -> config.actionBarChat, n -> config.actionBarChat = n)
