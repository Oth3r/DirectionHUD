...
//            }
    ...
    public static class Setting {
        ...
        public static CTxT getSettingButtons(Player player, Module module) {
            // assets
            Lang moduleLang = new Lang(LANG,module.getName()+".");
            ...
            if (module.equals(Module.COORDINATES)) {
                ...
                button.append(moduleLang.get(settingID+"."+(state? Hud.modules.SETTING_ON: Hud.modules.SETTING_OFF)).btn(true).color(CUtl.s())
                        .hover(CTxT.of("")
                                ...
                                .append(LANG.hover("set",moduleLang.get(settingID),moduleLang.get(settingID+"."+(state? Hud.modules.SETTING_OFF: Hud.modules.SETTING_ON)).color(CUtl.s()))))
                        .click(1,setCMD+settingID+" "+(state? Hud.modules.SETTING_OFF: Hud.modules.SETTING_ON)));
            }
            ...
            if (module.equals(Module.TRACKING)) {
                ...
                button.append(CTxT.of(currentType.equals(ModuleTracking.Type.simple)? Assets.symbols.arrows.up: Assets.symbols.arrows.north).btn(true).color(CUtl.s()).hover(CTxT.of("")
                                ...
                                .append(Hud.modules.moduleExample(player,Module.TRACKING).color(CUtl.s())).append("\n")
            ...
            if (module.equals(Module.ANGLE)) {
                ...
                String buttonIcon = switch (currentType) {
                    case yaw -> Assets.symbols.arrows.leftRight;
                    case pitch -> Assets.symbols.arrows.upDown;
                    default -> Assets.symbols.arrows.leftRight+ Assets.symbols.arrows.upDown;
                };
