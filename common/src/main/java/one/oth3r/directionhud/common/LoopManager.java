    ...
    public static void tick() {
        ...
        if (secondTick%2==0) {
            for (Player player : Utl.getPlayers()) {
                ...
                if (PlayerData.get.hud.getModule(player, HUD.Module.speed) && (boolean)PlayerData.get.hud.setting.get(player, HUD.Setting.state)) {
                    ...
                    if (!(boolean) PlayerData.get.hud.setting.get(player, HUD.Setting.module__speed_3d)) {
                        pos.set(1,0.0);
                        oldPos.set(1,0.0);
                    }
    ...
    private static void secondLoop(Player player) {
        ...
        if (target != null && (boolean)PlayerData.get.dest.setting.get(target, Destination.Setting.features__track)) {
            ...
            if (!target.getDimension().equals(player.getDimension())) {
                ...
                } else if (PlayerData.getMsgData(player, "tracking.dimension") == null) {
            ...
            } else if (PlayerData.getMsgData(player, "tracking.converted") != null) {
        ...
        } else if (PlayerData.getMsgData(player, "tracking.offline") == null && PlayerData.get.dest.getTracking(player) != null) {
